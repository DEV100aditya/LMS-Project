      ...
      <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
        ...
        border-white/30'>
          <div className='flex flex-col md:items-start items-center w-full'>
            ...
            <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum excepturi, 
              quis id aliquam, esse eveniet culpa ipsum ex inventore dolorem illum aspernatur.</p>
          </div>
          <div className='flex flex-col md:items-start items-center w-full'>
