...
const Hero = () => {
  return (
    ...
    px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
      ...
      courses designed to <span className='text-blue-600'>fit your choice.</span><img src={assets.sketch} alt="sketch" 
        ...
        <p className='md:block hidden text-gray-500 max-w-2xl mx-auto'>We bring 
            ...
            community to help you achieve personal and professional goals.</p>
